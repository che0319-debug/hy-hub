...
export default function Sidebar({ open, pilot = false }) {
  return (
    <aside className={`fixed ${pilot ? 'top-0 w-[242px] pilot-sidebar' : 'top-12 w-[200px]'} left-0 bottom-0 bg-white flex flex-col py-4 px-2 overflow-y-auto z-40 border-r border-slate-200 transition-transform duration-200 md:translate-x-0 ${open ? 'translate-x-0' : '-translate-x-full'}`}>
