...
export default function MemoryCenter({ embedded = false }) {
  ...
  const long = useMemo(() => (data?.longTerm || []).filter(x => status === 'archived' || x.status !== 'archived'), [data, status])
  return (
