...
function MilestoneCard({ item, colId, colName, onToggle, sessions, botConfig }) {
...
function BoardColumn({ col, onToggle, sessions, botConfig }) {
  return (
...
export default function AgentBoard({ boardData, botConfig }) {
